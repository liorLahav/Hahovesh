...
const Login = () => {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      const verificationResult = await sendVerificationCode(formatPhoneNumber(phoneNumber), recaptchaVerifier.current);
  ...
  const handleResendCode = async () => {
    ...
    setVerificationError("");
    try {
      const result = await sendVerificationCode(formatPhoneNumber(phoneNumber), recaptchaVerifier.current);
      if (!result.success) {
