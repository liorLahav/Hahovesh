                ...
                >
                  <View className="flex-row align-items-center p-3">
                    <View className="flex-1">
                      ...
                      <Text className="text-lg text-gray-700 text-center">{props.address + (props.addressType && " (" + props.addressType + ")" )}</Text>
                      {props.apartment_details && <Text className="text-sm text-gray-500 text-center">{props.apartment_details}</Text>}
                    </View>
                  </View>
                  <View className="bg-blue-50 py-2 px-3 border-t border-gray-100">
                    <Text className="text-sm text-blue-600 font-medium text-center">לחץ לניווט</Text>
                  </View>
                </Pressable>
    )
}
