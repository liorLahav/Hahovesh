    ...
    <>
      ...
      <View style={tw`relative h-24 justify-center bg-blue-50 items-center border-b border-blue-300`}>
        ...
        <Image
          ...
          style={[tw`absolute left-4 top-5`, { width: 45, height: 45 }]}
          resizeMode="contain"
        />

        {/* התוכן המרכזי */}
        <View style={tw`items-center justify-center`}>
          <Text style={tw`text-[24px] font-bold text-gray-800`}>הודעות</Text>
          <Text style={tw`text-[15px] text-gray-700`}>החובש הר נוף</Text>
        </View>
      </View>
    </>
  );
