...
const formSchema_eventSummary: SchemaField[] = [
  ...
  { key: 'gender', label: 'מין המטופל', type: 'picker', options: [
    { label: 'זכר', value: 'זכר' },
  ...
  { key: 'receiver', label: 'מוקד מקבל', type: 'picker', options: [
    { label: 'מד"א', value: 'מד"א' },
  ...
  { key: 'event_location', label: 'מיקום האירוע', type: 'picker', options: [
  ...
  { key: 'pulse_state', label: 'מצב דופק', type: 'picker', options: [
    { label: 'סדיר', value: 'סדיר' },
    { label: 'לא סדיר', value: 'לא סדיר' },
    { label: 'ללא דופק', value: 'ללא דופק' }
  ] },
  { key: 'consciousness', label: 'מצב הכרה', type: 'picker', options: [
  ...
  { key: 'breathing', label: 'מצב נשימה', type: 'picker', options: [
  ...
  { key: 'oxygen', label: 'חמצן', type: 'picker', options: [
  ...
  { key: 'resuscitation_actions', label: 'החייאה ', type: 'multiselect', options: [
  ...
  { key: 'transport', label: 'פינוי', type: 'picker', options: [
